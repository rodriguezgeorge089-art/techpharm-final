...
def prescription_upload():
    if request.method == 'POST':
        ...
        try:
            ...
            msg = t("prescription_received")
            return public_page(msg,
                f'<div class="text-center mt-5"><i class="fas fa-check-circle fa-5x text-success mb-3"></i><h2>{msg}</h2><p>{msg}</p><a href="/" class="btn btn-primary rounded-pill mt-3">Home</a></div>')
        except Exception as ex:
...
# ---------- Admin: Bundles (precompute items) ----------
