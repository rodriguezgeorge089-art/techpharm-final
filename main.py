...
# ---------- Product Detail & Reviews (only approved) ----------
...
def symptom_checker():
    ...
    result_html = ''
    if results:
        result_html = f'<h4 class="mt-4">Recommended Products</h4><div class="row">'
        for p in results:
...
# ---------- Admin: Products (with search, pagination, delete via POST, low-stock alert) ----------
