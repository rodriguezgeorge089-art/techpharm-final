...
from starlette.middleware.sessions import SessionMiddlewareimport os, io, csv, urllib.parse
from fastapi import FastAPI, Request, Form, File, UploadFile
from fastapi.responses import HTMLResponse, RedirectResponse, StreamingResponse
...
<section class="bg-light py-5">
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-3"><a href="/shop?category=Women+Health" class="text-decoration-none"><div class="top-category-card"><i class="fas fa-female fa-2x text-pink mb-2" style="color:#e83e8c;"></i><h5>Women Health</h5></div></a></div>
        </div>
    </div>
</section>
...
<section class="bg-light py-5">
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-3"><a href="/shop?category=Digestion" class="text-decoration-none"><div class="category-card"><i class="fas fa-stethoscope fa-2x text-success mb-2"></i><h5>Digestion</h5></div></a></div>
            <div class="col-md-3"><a href="/shop?category=Vitamins" class="text-decoration-none"><div class="category-card"><i class="fas fa-leaf fa-2x text-warning mb-2"></i><h5>Vitamins</h5></div></a></div>
        </div>
    </div>
</section>
<footer class="footer"><div class="container"><div class="row">
    ...
    <div class="row g-3">
        ...
        <div class="col-md-3">
            <select class="form-control" name="category">
                <option value="">All Categories</option>
                <option value="Pain Relief" {'selected' if category=='Pain Relief' else ''}>Pain Relief</option>
                <option value="Allergy" {'selected' if category=='Allergy' else ''}>Allergy</option>
                <option value="Digestion" {'selected' if category=='Digestion' else ''}>Digestion</option>
                <option value="Vitamins" {'selected' if category=='Vitamins' else ''}>Vitamins</option>
            </select>
        </div>
        <div class="col-md-1"><button class="btn btn-primary w-100">Search</button></div>
    </div>
